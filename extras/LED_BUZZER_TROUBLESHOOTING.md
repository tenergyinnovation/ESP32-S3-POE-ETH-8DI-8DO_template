...
| Buzzer | GPIO46 | PWM Output | 1kHz default, 8-bit PWM (0-255) |
...
| Buzzer | 3.3V | ~50mA | Check GPIO46 pulls high |
...
- [ ] Buzzer connected to GPIO46 with proper current limiting
...
2. **Verify Buzzer:** Check GPIO46 PWM frequency and duty cycle settings
