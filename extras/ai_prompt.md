...
ในโค้ด main.cpp เราสามารถตรวจสอบสถานะของ ESP32S3 ตามหัวข้อนี้ได้หรือไม่?

1. อุณหภูมิของ ESP32S3
2. mac address ของ ESP32S3
3. ram size ของ ESP32S3 และ ram free ของ ESP32S3
4. flash size ของ ESP32S3 และ flash free ของ ESP32S3
5. ค่าอื่นๆ ของ ESP32S3